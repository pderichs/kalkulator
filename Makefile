...
CPPFLAGS=-std=c++17 -g -Wall -Wpedantic -Wextra -Weffc++ -Werror -I$(TOOLS_DIR) -I$(TESTS_DIR) -Ivendor/sqlite3 $(WX_INCLUDES) $(WX_DEFINES)
...
SRCS+=$(SRC_DIR)/view/table_sheet_view.cpp
SRCS+=$(SRC_DIR)/view/table_formula_text_control.cpp
SRCS+=$(SRC_DIR)/view/table_cell_format_dlg.cpp
...
SRCS+=$(SRC_DIR)/model/lisp/value_converter.cpp
