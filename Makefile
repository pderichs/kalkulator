...
#CPPFLAGS=-std=c++17 -O3 -Wall -Wpedantic -Wextra -Weffc++ -I$(TOOLS_DIR) -I$(MODEL_SRC_DIR) -I$(TESTS_DIR) $(WX_INCLUDES) $(WX_DEFINES)
CPPFLAGS=-std=c++17 -g -Wall -Wpedantic -Wextra -Weffc++ -I$(TOOLS_DIR) -I$(MODEL_SRC_DIR) -I$(TESTS_DIR) $(WX_INCLUDES) $(WX_DEFINES)
LDFLAGS=$(WX_LDFLAGS)
LDLIBS=
