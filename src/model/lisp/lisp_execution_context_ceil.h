...
#ifndef LISP_EXECUTION_CONTEXT_CEIL_H
#define LISP_EXECUTION_CONTEXT_CEIL_H
...
public:
  LispValuePtr value(const LispValuePtrVector &func,
    ...
    LispValue::DoubleType result = std::ceil(params[0]->to_double());
    return LispValueFactory::new_double(result);
  }
};

#endif //LISP_EXECUTION_CONTEXT_CEIL_H
